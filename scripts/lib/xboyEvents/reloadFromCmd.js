...
world.afterEvents.playerJoin.subscribe(event => reloadFromCmd.players.add(event.playerId));
world.afterEvents.playerLeave.subscribe(event => reloadFromCmd.players.delete(event.playerId));
system.runInterval(() => {
