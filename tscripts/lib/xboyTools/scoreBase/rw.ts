...
const AddScorePointsAsync    = (...args: string[])=>{overworld.runCommandAsync(`scoreboard players add ${args[0]} ${(typeof args[1] === typeof "Xboy minemc")?args[1]:('"'+args[1].id+'"')} ${args[2]}`)};
const SetScorePointsAsync    = (...args: string[])=>{overworld.runCommandAsync(`scoreboard players set ${args[0]} ${(typeof args[1] === typeof "Xboy minemc")?args[1]:('"'+args[1].id+'"')} ${args[2]}`)};

const AddScorePoints    = (...args: string[])=>{overworld.runCommand(`scoreboard players add ${args[0]} ${(typeof args[1] === typeof "Xboy minemc")?args[1]:('"'+args[1].id+'"')} ${args[2]}`)};
const SetScorePoints    = (...args: string[])=>{overworld.runCommand(`scoreboard players set ${args[0]} ${(typeof args[1] === typeof "Xboy minemc")?args[1]:('"'+args[1].id+'"')} ${args[2]}`)};
